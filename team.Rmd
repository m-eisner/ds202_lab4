...
The defense played better against Notre Dame. This is because many of the data points are close to the y axis, meaning that many players only had 0 to 2 solo tackles in the Iowa game but got anywhere from 0 to 6 solo tackles in the Notre Dame game.
...
dat %>% ggplot(aes(x=Iowa, y=`Notre Dame`)) + geom_point() +
  ggtitle("Solo Tackles by ISU Defense: Notre Dame vs Iowa")
```
